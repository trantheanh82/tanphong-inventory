...
- Analyze the image carefully. Return any valid information you find. If you find both, return both. If you find only one, return only that one. If you find neither, return an empty object.
