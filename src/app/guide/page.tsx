            ...
            <Card className="bg-white/50 backdrop-blur-md rounded-xl shadow-lg border border-white/50">
                ...
                <CardContent className="text-gray-800">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-blue-700">
                        <li><a href="#nhap-kho" className="hover:underline">1. Quy trình Nhập Kho</a></li>
                        <li><a href="#xuat-kho" className="hover:underline">2. Quy trình Xuất Kho</a></li>
                        <li><a href="#bao-hanh" className="hover:underline">3. Quy trình Bảo Hành</a></li>
                        <li><a href="#quan-ly-phieu" className="hover:underline">4. Xem và Quản lý các Phiếu</a></li>
                        <li><a href="#ca-nhan" className="hover-underline">5. Quản lý Thông tin Cá nhân</a></li>
                    </ul>
                </CardContent>
            </Card>
